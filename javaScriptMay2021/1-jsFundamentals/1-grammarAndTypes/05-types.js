...
//Null
/*
Null means a variable has been declared and assigned a valuable of null
*/
...
Denoted by {}
Have keys and values color (key): 'blue (value), separated with a colon between the key and value, each key-value pair is separated with a comma
*/
...
Denoted by []
Have values of ('blue', 'green', 'yellow'), separated by commas
*/
